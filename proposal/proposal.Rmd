...
We are utilising two datasets from the CDC website for this project. The first one entitled United States COVID-19 Cases and Deaths by State over Time reports aggregate counts of COVID-19 cases and death numbers daily and are based on the most recent numbers reported by states, territories, and other jurisdictions. The second dataset, COVID-19 Vaccinations in the United States, shows the overall US COVID-19 Vaccine deliveries and administration data at national and jurisdiction level.
