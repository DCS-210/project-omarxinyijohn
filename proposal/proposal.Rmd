...
- Outcome _y_ & Predictor Variable _x_ and Other Variables
  ...
  2) `US_vaccinations`: 
  total J&J, Pfizer, and Moderna vaccine distributed (store `Distributed_Janssen, Distributed_Moderna, Distributed_Pfizer` into one variable) & count (no _y_ specified); states (`facet_wrap~(state)`); 
...
```{r data-summary-deaths-cases}
#US_deaths_cases %>%

```

    
```{r data-summary-vaccinations}
#US_vaccinations %>%
...
```{r cases/deaths-vaccinations/vaccinations-rates}
