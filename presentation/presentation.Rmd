...
vax_deaths_ccf_plot <- xcf_plot(df = merged_US_data, 
         ...
         title = "Cross Correlation : Daily New Deaths and Fully Vaccinated Percent of Population",
         lag_var = 250)
...
### Exploring the Relationship Between Vaccinations and Cases/Deaths
```{r, echo = FALSE, fig.show='hide'}
ccf_raw_data2 <- ccf(merged_US_data$Series_Complete_Pop_Pct, merged_US_data$total_new_deaths, plot = FALSE, lag.max = 100) 
...
---
### Exploring the Seasonality of COVID-19
```{r, echo = FALSE, message = FALSE, fig.width = 16, fig.height = 7.5}
